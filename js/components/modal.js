...
export function launchModal() {
    ...
    <div class="formData" id="firstnameField">
        ...
        <input class="text-control" type="text" id="firstname" name="firstname" placeholder="Veuillez entrer 2 caractères ou plus pour le prenom" /><br>
    </div>

    <div class="formData" id="lastnameField">
        <label for="lastname">Nom</label><br>
        <input class="text-control" type="text" id="lastname" name="lastname" placeholder="Veuillez entrer 2 caractères ou plus pour le nom"/><br>
    </div>
